...
const filterdUserList = userList.filter(user => user.userName.length === 8);
...
//         ex) 10명 중 서울사는 애들 필터링 -> 서울에 사는애 아니면 사라짐
// map: 10개의 데이터를 매핑하면 항상 10개 남음
...
// 회원목록에서 회원 이름, 나이, 주소를 추출
// 이름의 키값을 nickName, 나이는 old, 주소는 addr로 변경
